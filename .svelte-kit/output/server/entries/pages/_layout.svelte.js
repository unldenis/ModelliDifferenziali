...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="svelte-1u9z1tp"><div class="corner svelte-1u9z1tp"><a href="https://github.com/unldenis" class="svelte-1u9z1tp"><img${add_attribute("src", github, 0)} alt="GitHub" class="svelte-1u9z1tp"></a></div>
	...
	<nav class="svelte-1u9z1tp"><svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-1u9z1tp"></path></svg>
		<ul class="svelte-1u9z1tp"><li${add_attribute("aria-current", $page.url.pathname === "/" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/" class="svelte-1u9z1tp">Home</a></li>
			<li${add_attribute("aria-current", $page.url.pathname === "/es1" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/es1" class="svelte-1u9z1tp">Es1</a></li>
			<li${add_attribute("aria-current", $page.url.pathname === "/es2" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/es2" class="svelte-1u9z1tp">Es2</a></li>
			<li${add_attribute("aria-current", $page.url.pathname === "/es3" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/es3" class="svelte-1u9z1tp">Es3</a></li>
			<li${add_attribute("aria-current", $page.url.pathname === "/es4" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/es4" class="svelte-1u9z1tp">Es4</a></li></ul>
...
const css = {
  code: ".app.svelte-gfjft6{display:flex;flex-direction:column;min-height:100vh}main.svelte-gfjft6{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:64rem;margin:0 auto;box-sizing:border-box}footer.svelte-gfjft6{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:12px}@media(min-width: 480px){footer.svelte-gfjft6{padding:12px 0}}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="app svelte-gfjft6">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}

	<main class="svelte-gfjft6">${slots.default ? slots.default({}) : ``}</main>

	<footer class="svelte-gfjft6"><p>fatto da Denis Mehilli</p></footer>
</div>`;
});
export {
  Layout as default
